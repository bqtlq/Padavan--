...
lan_ip="192.168.200"                                  # LAN 地址 别写后面的 .1
wlan_2g_ssid="YZ-100A"                              # 2G 无线名称
wlan_5g_ssid="YZ-100A_5G"                           # 5G 无线名称
wlan_guest_2g_ssid="YZ-100A_Guset"                  # 2G 访客无线名称
wlan_guest_5g_ssid="YZ-100A_Guest_5G"               # 5G 访客无线名称
wlan_2g_psk="a123456789"                            # 2G WIFI密码最少8位 空白为不设置
wlan_5g_psk="a123456789"                            # 5G WIFI密码最少8位 空白为不设置
